...
.then(
    function(data)
    {
      ...
      function getColor(magnitude) {
        if (magnitude > 5) {return "#ea2c2c"; //red //return "#BD40AE"; pink
        }
        else if (magnitude > 4) {return "#ea822c"; //orange //return "#8A3AA6"; purple
        }
        else {return "#3A56A6"; //yellow //return "#3A56A6"; blue
        }  
      }
